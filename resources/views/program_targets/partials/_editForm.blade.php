  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('improved_seed_target', $targets['improved_seed_target'], array('class' => 'form-control', 'placeholder' => 'improved seed ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('improved_storage_target', $targets['improved_storage_target'], array('class' => 'form-control', 'placeholder' => 'improved storage ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('improved_tools_target', $targets['improved_tools_target'], array('class' => 'form-control', 'placeholder' => 'improved tools & practices ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('farmers_with_irrigation_target', $targets['improved_tools_target'], array('class' => 'form-control', 'placeholder' => '# farmers using irrigation ')) !!}
      </div>
    </div>
...
{{-- }}
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('increase_in_yield_per_hectare_target', $targets['increase_in_yield_per_hectare_target'], array('class' => 'form-control', 'placeholder' => '% Increase in Yield per Ha ')) !!}
      </div>
    </div>
--}}
-->
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('ha_with_irrigation_target', $targets['ha_with_irrigation_target'], array('class' => 'form-control', 'placeholder' => '# Ha Farmland with Irrigation ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_savings_groups_target', $targets['num_savings_groups_target'], array('class' => 'form-control', 'placeholder' => '# of Savings Groups ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_savings_group_members_target', $targets['num_savings_group_members_target'], array('class' => 'form-control', 'placeholder' => '# Savings Group Members ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('savings_groups_total_balance_target', $targets['savings_groups_total_balance_target'], array('class' => 'form-control', 'placeholder' => 'Total Bal of SG Accounts ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('members_with_vf_loan_target', $targets['members_with_vf_loan_target'], array('class' => 'form-control', 'placeholder' => '# VF Clients with Loans ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('farmers_with_vc_ins_target', $targets['farmers_with_vc_ins_target'], array('class' => 'form-control', 'placeholder' => '# Farmers Using VC Insurance ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('num_producers_groups_target', $targets['num_producers_groups_target'], array('class' => 'form-control', 'placeholder' => '# of Producers Groups ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('num_producers_group_members_target', $targets['num_producers_group_members_target'], array('class' => 'form-control', 'placeholder' => '# of PG Members ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_prod_groups_sell_vc_product_target', $targets['num_prod_groups_sell_vc_product_target'], array('class' => 'form-control', 'placeholder' => '# of PGs who Sell VC Products ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_prod_groups_local_markets_target', $targets['num_prod_groups_local_markets_target'], array('class' => 'form-control', 'placeholder' => '# of PGs Using Local Markets ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_prod_groups_expanded_markets_target', $targets['num_prod_groups_expanded_markets_target'], array('class' => 'form-control', 'placeholder' => '# of PGs Using Expanded Markets ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('hectares_reclaimed_for_ag_target', $targets['hectares_reclaimed_for_ag_target'], array('class' => 'form-control', 'placeholder' => '# Ha Reclaimed for Ag ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('hectares_farmed_soil_water_cons_target', $targets['hectares_farmed_soil_water_cons_target'], array('class' => 'form-control', 'placeholder' => '# Ha. with Soil & Water Cons Techniques ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('farmers_using_water_catchment_target', $targets['farmers_using_water_catchment_target'], array('class' => 'form-control', 'placeholder' => '# Using Water Catchment Techniques ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('comm_watershed_rehab_target', $targets['comm_watershed_rehab_target'], array('class' => 'form-control', 'placeholder' => '# of Comm With Watershed Protected ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('trees_planted_target', $targets['trees_planted_target'], array('class' => 'form-control', 'placeholder' => '# of Trees Planted/Regenerated ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('members_with_emer_savings_target', $targets['members_with_emer_savings_target'], array('class' => 'form-control', 'placeholder' => '# of THRIVE Participants With Emergency Savings ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('farmers_using_ews_target', $targets['farmers_using_ews_target'], array('class' => 'form-control', 'placeholder' => '# of Farmers Using EWS ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('members_received_ewv_training_target', $targets['members_received_ewv_training_target'], array('class' => 'form-control', 'placeholder' => '# of People Having Received EWV Training ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('ewv_trainees_attest_value_trans_target', $targets['ewv_trainees_attest_value_trans_target'], array('class' => 'form-control', 'placeholder' => '# of EWV Trainees Attesting to Value Transformation ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('faith_leaders_in_ewv_training_target', $targets['faith_leaders_in_ewv_training_target'], array('class' => 'form-control', 'placeholder' => '# of Faith Leaders Engaged in EWV Training ')) !!}
      </div>
    </div>
    ...
    $(document).ready(function() {
      ...
      var country = <?php echo $country->country_id ?>;
    ...
    <div class="form-group row" id="political" style="display:none;">
      ...
      <div class="col-md-2">
        {!! Form::text('groups_undertaking_political_rep_target', $targets['groups_undertaking_political_rep_target'], array('class' => 'form-control', 'placeholder' => '# of Vulnerable Groups Undertaking Political Representation')) !!}
      </div>
    </div>
    ...
    <div class="form-group row" id="cva" style="display:none;">
      ...
      <div class="col-md-2">
        {!! Form::text('participants_trained_in_cva_target', $targets['participants_trained_in_cva_target'], array('class' => 'form-control', 'placeholder' => '# of Project Participants Trained in CVA')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('children_given_care_by_groups_target', $targets['children_given_care_by_groups_target'], array('class' => 'form-control', 'placeholder' => '# of Vulnerable Children Given Care by the Groups ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('unique_hh_inc_sources_target', $targets['unique_hh_inc_sources_target'], array('class' => 'form-control', 'placeholder' => '# of Unique Household Income Sources in Previous 3 Months ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('direct_beneficiaries_target', $targets['direct_beneficiaries_target'], array('class' => 'form-control', 'placeholder' => '# of Direct Beneficiaries ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('num_children_target', $targets['num_children_target'], array('class' => 'form-control', 'placeholder' => '# of Children ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2 justify-content-center">
        {!! Form::text('num_women_target', $targets['num_women_target'], array('class' => 'form-control', 'placeholder' => '# of Women ')) !!}
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
        {!! Form::text('num_hh_members_target', $targets['num_hh_members_target'], array('class' => 'form-control', 'placeholder' => '# of HH Members ')) !!}
      </div>
    </div>
