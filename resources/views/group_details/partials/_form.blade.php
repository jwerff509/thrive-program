<div class="container-fluid">
  ...
  <div class="form-group row">
    {!! Form::label('savings_group_members', 'ID9: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('account_balance', 'ID10: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('group_meetings', 'ID11: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('primary_value_chain', 'G1: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_with_irrigation', 'G7: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_with_vf_loan', 'G8: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_with_crop_ins', 'G9: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('hectares_reclaimed1', 'G10: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_using_soil_water_cons', 'G11: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_using_water_catchment', 'G12: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('value_chain_unit', 'G13: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
      {!! Form::select('value_chain_unit', array('default' => 'Primary Value Chain Unit...') + $valueChainUnits, array('id' => 'id', 'class' => 'form-control')) !!}
    </div>
  </div>
  ...
  <div class="form-group row">
    {!! Form::label('hectares_reclaimed2', 'G18: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_with_emergency_savings', 'G19: ', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('ews_established', 'G20: EWS established', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
  ...
  <div class="form-group row">
    {!! Form::label('members_attended_ewv_training', 'G21: EWV training', array('class' => 'col-md-5 form-control-label text-right')) !!}
    <div class="col-md-2">
