  ...
  <script>
    ...
    window.onload = function() {
      ...
      var soilCons = document.getElementById("soilConsChart").getContext("2d");

      window.multiBar = new Chart(soilCons, {
        type: 'bar',
        data: {
      ...
      var waterCatch = document.getElementById("waterCatchChart").getContext("2d");

      window.multiBar = new Chart(waterCatch, {
        type: 'bar',
        data: {
