...
class DashboardController extends Controller
{
  ...
  public function countryDashboard($id) {
    ...
    $data = array(
      ...
      'childCareByGroupsBarWidth' => $childCareByGroupsBarWidth,
...
*/
    ...
    return view('charts.eloDashboard_TESTING')->with($data);
  ...
  public function numFormat($num, $type) {

    if($type == '#') {
      return number_format($num);
    } elseif($type == '$') {
      return sprintf('U$ %s', number_format($num));
    }
